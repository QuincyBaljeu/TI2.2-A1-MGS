...
public class CustomRouting extends CustomAbstractRouting {
    ...
    public static class Builder {
        ...
        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder travelMode(TravelMode travelMode) {
            this.travelMode = travelMode;
            return this;
        }

        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder alternativeRoutes(boolean alternativeRoutes) {
            this.alternativeRoutes = alternativeRoutes;
            return this;
        }

        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder waypoints(LatLng... points) {
            this.waypoints.clear();
            Collections.addAll(this.waypoints, points);
            return this;
        }

        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder waypoints(List<LatLng> waypoints) {
            this.waypoints = new ArrayList(waypoints);
            return this;
        }

        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder optimize(boolean optimize) {
        ...
        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder language(String language) {
            this.language = language;
            return this;
        }

        public com.example.ti22_a1_mgs.utils.CustomRouting.Builder key(String key) {
            this.key = key;
            return this;
        }
